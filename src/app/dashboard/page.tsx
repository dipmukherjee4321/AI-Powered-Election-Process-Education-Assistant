    ...
    <div className="space-y-8 max-w-6xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="glass p-6 md:p-8 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 border-b-4 border-b-primary shadow-sm">
        <div>
          ...
          <p className="text-foreground/70">
            You are securely logged in to your personalized dashboard.
          </p>
        </div>

        {/* Command Box */}
        <div className="w-full md:w-96 bg-surface/50 p-4 rounded-xl border border-surface-dark/10">
          <label htmlFor="command" className="flex items-center gap-2 text-sm font-semibold text-foreground/80 mb-2">
          ...
          <form onSubmit={executeCommand} className="relative">
            <input
              ...
              className="w-full pl-4 pr-10 py-2.5 bg-background border border-surface-dark/20 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-all font-mono text-sm"
              autoComplete="off"
            />
            <button
              type="submit"
              aria-label="Execute Command"
              className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 text-primary hover:bg-primary/10 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6" aria-live="polite">
        <div className="glass p-6 rounded-2xl flex items-center justify-between border-l-4 border-l-blue-500">
          <div>
            <p className="text-foreground/60 text-sm font-semibold uppercase tracking-wider mb-1">
              Total Mock Votes
            </p>
