  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (
        ...
        toast.loading("Popup blocked or failed. Retrying with redirect...", {
          id: toastId,
        });
        ...
        toast.error(
          "Google Sign-In is disabled. Enable it in Firebase Console > Build > Authentication > Sign-in method.",
      ...
      <div className="w-full max-w-md glass p-8 rounded-2xl shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="space-y-4 mb-8">
          <button
            ...
            className="w-full flex items-center justify-center py-3 px-4 border border-surface-dark/20 rounded-xl shadow-sm text-sm font-semibold bg-white text-gray-700 hover:bg-gray-50 transition-all active:scale-[0.98] disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            <GoogleIcon />
        ...
        <form onSubmit={handleAuth} className="space-y-5">
          <div className="space-y-1">
            <label htmlFor="email" className="text-sm font-medium text-foreground/80 px-1">
              Email Address
            </label>
            <div className="relative">
          ...
          <div className="space-y-1">
            <label htmlFor="password" className="text-sm font-medium text-foreground/80 px-1">
              Password
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-foreground/50">
          ...
          <button
            ...
            className="w-full flex items-center justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-primary hover:bg-primary-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-[0.98]"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="text-sm font-semibold text-primary hover:underline transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded"
          >
            {isSignUp
