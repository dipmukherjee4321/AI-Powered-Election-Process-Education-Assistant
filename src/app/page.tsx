...
const Vote = dynamic(() => import("lucide-react").then((mod) => mod.Vote), {
  ssr: true,
});
    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] gap-12">
      ...
      <section className="text-center max-w-3xl space-y-6">
        ...
        <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
          Your AI-powered guide to understanding how democracy works. From
          nominations to results, learn at your own pace with interactive
          modules.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
        ...
        <Link
          href="/learn"
          className="group glass rounded-2xl p-6 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-primary/20"
        >
          ...
          <p className="text-foreground/70 mb-4 line-clamp-2">
            Explore the step-by-step election timeline with animated
            visualizations and micro-explanations.
          </p>
        ...
        <Link
          href="/chat"
          className="group glass rounded-2xl p-6 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-secondary/20"
        >
          ...
          <p className="text-foreground/70 mb-4 line-clamp-2">
            Ask any questions about elections. Choose from Simple, Detailed, or
            Exam modes. Multi-language supported.
          </p>
        ...
        <Link
          href="/quiz"
          className="group glass rounded-2xl p-6 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-green-500/20"
        >
          ...
          <p className="text-foreground/70 mb-4 line-clamp-2">
            ...
            skill level and track your progress.
          </p>
        ...
        <Link
          href="/vote"
          className="group glass rounded-2xl p-6 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-orange-500/20"
        >
          ...
          <p className="text-foreground/70 mb-4 line-clamp-2">
            Experience a secure, simulated voting environment with mock
            candidates and real-time result visualization.
          </p>
