...
import { 
  Megaphone, FileSignature, Users, 
  Vote, Calculator, Trophy, ChevronRight 
} from "lucide-react";
...
const STAGES = [
  {
    ...
    icon: Megaphone,
    color: "bg-blue-500",
    description: "The Election Commission officially announces the dates for polling and counting. The Model Code of Conduct comes into effect immediately.",
    details: [
  ...
  },
  {
    ...
    icon: Users,
    color: "bg-orange-500",
    description: "Political parties and candidates reach out to voters through rallies, manifestos, and advertisements.",
    details: [
  ...
  },
  {
    ...
    icon: Vote,
    color: "bg-green-500",
    description: "Citizens cast their votes secretly at designated polling booths using EVMs or ballot papers.",
    details: [
  ...
  },
  {
    ...
    icon: Calculator,
    color: "bg-yellow-500",
    description: "Votes are counted under the strict supervision of the Election Commission and candidate representatives.",
    details: [
  ...
  },
  {
    ...
    icon: Trophy,
    color: "bg-red-500",
    description: "Final results are declared. The candidate with the highest number of valid votes in a constituency is elected.",
    details: [
...
export default function Timeline() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      {/* Visual Timeline Bar */}
      <div className="relative flex justify-between items-center mb-16 before:absolute before:inset-0 before:top-1/2 before:-translate-y-1/2 before:h-1 before:bg-surface-dark/10 dark:before:bg-surface-light/10 before:-z-10">
            ...
            >
              <motion.div 
                ...
                animate={{
                  ...
                  color: isActive || isPast ? "#fff" : "var(--color-foreground)"
                }}
              ...
              <div className={`absolute top-14 text-sm font-medium whitespace-nowrap transition-colors
      ...
      <div className="mt-12">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="glass rounded-2xl p-8 border border-surface-dark/10 shadow-lg relative overflow-hidden"
          >
            {/* Background accent */}
            <div className={`absolute -top-24 -right-24 w-64 h-64 rounded-full opacity-10 blur-3xl ${STAGES[activeStage].color}`} />
            
            <div className="flex items-start gap-6 relative z-10">
              <div className={`p-4 rounded-xl text-white shadow-md ${STAGES[activeStage].color}`}>
                {(() => {
              ...
              <div className="flex-1">
                <h3 className="text-3xl font-bold mb-4">{STAGES[activeStage].title}</h3>
                <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
                  {STAGES[activeStage].description}
                </p>
                
                <div className="bg-background/50 rounded-xl p-5 border border-surface-dark/5 dark:border-surface-light/5">
                  <h4 className="font-semibold text-sm uppercase tracking-wider text-primary mb-3">Key Activities</h4>
            ...
            <div className="flex justify-between mt-8 pt-6 border-t border-surface-dark/10 dark:border-surface-light/10">
              <button
                ...
                className="px-4 py-2 rounded-lg font-medium text-foreground/70 hover:bg-surface/50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              >
                Previous Stage
              </button>
              <button
                ...
                className="px-6 py-2 bg-primary text-white rounded-lg font-medium shadow hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95"
              >
