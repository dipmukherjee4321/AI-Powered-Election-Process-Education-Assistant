...
export default function ChatInterface() {
  ...
  return (
    <div
      className="flex flex-col h-[calc(100vh-12rem)] max-w-4xl mx-auto glass rounded-2xl overflow-hidden shadow-xl"
      role="region"
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between p-4 border-b border-surface-dark/10 dark:border-surface-light/10 bg-surface/50">
        ...
        <div
          className="flex bg-background/80 rounded-lg p-1"
          role="group"
      ...
      <div className="p-4 bg-surface/50 border-t border-surface-dark/10 dark:border-surface-light/10">
        ...
        >
          <button
            ...
            className={`p-3 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-primary ${
              isListening
                ...
                : "bg-surface border border-surface-dark/20 text-foreground/70 hover:bg-surface-dark/10"
            }`}
          >
            {isListening ? (
          ...
          <input
            ...
            className="flex-1 pl-4 pr-12 py-3 rounded-xl border border-surface-dark/20 dark:border-surface-light/20 bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 transition-shadow"
            disabled={isLoading}
            autoComplete="off"
          />
          <button
            ...
            className="absolute right-2 p-2 rounded-lg bg-primary text-white hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            <Send size={18} />
          </button>
        </form>
